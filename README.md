...
Please see version numbers. Updates are released first on GitHub before that are sent to SSC.
...
The package is still in *beta* and may still need further improvements, error checks. Please report these in the [Issues](https://github.com/asjadnaqvi/stata-clipgeo/issues) section.
