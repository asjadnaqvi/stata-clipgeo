...
If you want to do other type of clippings, then use {stata help clippolygon:clippolygon} which supercedes {cmd:clippolyline}. For box clipping, {cmd:clippolyline} is still much faster.


{marker syntax}{title:Syntax}
{p 8 15 2}
{cmd:clippolyline} {it:filename}, {cmdab:b:ox}({it:xmin, xmax, ymin, ymax})


{synoptset 36 tabbed}{...}
{synopthdr}
{synoptline}
{p2coldent : {it:filename}}is the {it:*_shp.dta} file generated by Stata's {stata help spshape2dta:spshape2dta} command that contains line coordinates.{p_end}

{p2coldent : {opt b:ox(xmin, xmax, ymin, ymax)}}The bounding box coordinates need to be specified in the correct order.{p_end}
